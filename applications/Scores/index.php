  ...
  <body spellcheck="false">
    ...
    <div class="container-fluid" style="margin-top: 10px;">
      <div class="row" id="first-item">
        <div class="col-md-12">
          <p class="tut-p">Create and share derived values (scores) by describing the rational for creating the new variable. Add the algorithm based on existing measures in JavaScript notation. This could be as simple as a different quantization of an existing continuous variable or as complex as a new t-score table used to map values to some standard sample. The Score is calculated by first copying the columns with the required variables to your browser followed by the calculation and storage of the new values in the data frame and by pushing the new column back to the server for storage.</p>
